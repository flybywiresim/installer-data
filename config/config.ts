    ...
    publishers: [
        {
            ...
            addons: [
                ...
                },
                {
                    ...
                    shortDescription: 'Airbus A380-800',
                    description: `<span style="color: rgb(255, 106, 0);">&#9888; Important: Starting with version 0.6.0, custom resources such as PDF Charts and Company Routes must be stored in the Documents folder (typically located at \`C:\\Users\\<Username>\\Documents\\FlyByWireSim\\Simbridge\\resources)\`. Please ensure you back up your files before updating. After the update, transfer your files to this new location to keep them safe from future updates. You can also use the Resources button in the About section of the installer to locate the folder.</span>  SimBridge is an external application that allows FlyByWire Simulations aircraft to interact beyond your simulator. It supports a range of optional features, from remote displays to external terrain rendering.`,                     
